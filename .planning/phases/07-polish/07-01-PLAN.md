...
must_haves:
  truths:
    - "react-loading-skeleton and react-error-boundary are installed"
    - "Modal open/close animations are smooth (fade + scale)"
    - "Focus ring utility class is available for keyboard navigation"
  artifacts:
    - path: "package.json"
