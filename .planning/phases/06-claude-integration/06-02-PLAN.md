...
<task type="auto">
  ...
  <action>
    ...
    1. src/components/chat/MessageContent/MessageContent.jsx:
       ...
       - Map parts: if matches CALL-XXXX pattern, extract callId and render Citation component with id={callId}
       - NOTE: Citation component already wired to open CitationModal via modalStore (Phase 5 wiring) - no onClick needed
       - For non-citation parts, render text with line breaks preserved
